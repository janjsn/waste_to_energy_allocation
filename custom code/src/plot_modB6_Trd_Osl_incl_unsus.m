function plot_modB6_Trd_Osl(Trondheim, Oslo, Trondheim_80, Oslo_80)
...
em_hp_nor_ns3720_chp_5(1:end) = lca_em_gshp_production_gCO2eq_per_kWh +(Trondheim.emission_intensity_nor_ns3720_2019_2075_gCO2eq_per_kWh)/COP_hp(2);
em_hp_eu_ns3720_chp_5(1:end) = lca_em_gshp_production_gCO2eq_per_kWh +(Trondheim.emission_intensity_eu28_nor_ns3720_2019_2075_gCO2eq_per_kWh)/COP_hp(2);
...
em_Trd_80_dh = Trondheim_80.B_emission_intensity_dh_delivered_heat_mean_gCO2eq_per_kWh;
em_Oslo_80_dh = Oslo_80.B_emission_intensity_dh_delivered_heat_mean_gCO2eq_per_kWh;

err_Trd_80 = Trondheim_80.B_emission_intensity_dh_delivered_heat_gCO2eq_per_kWh_std_high-em_Trd_80_dh;
err_Oslo_80 = Oslo_80.B_emission_intensity_dh_delivered_heat_gCO2eq_per_kWh_std_high-em_Oslo_80_dh;
...
boundedline(B_cont, em_Trd_80_dh, 2*err_Trd_80, 'alpha', 'Color', colors(6,:), 'LineWidth', 2, '-.');
boundedline(B_cont, em_Oslo_80_dh, 2*err_Oslo_80, 'alpha', 'Color', colors(3,:), 'LineWidth', 2, '-.');


plot(B_cont, em_hp_nor_ns3720, 'LineWidth', 3,'Color','black', 'LineStyle', '--');
%plot(B_cont, em_hp_eu_ns3720, 'LineWidth', 2,'Color', colors(4,:), 'LineStyle', '--');
plot(B_cont, em_hp_nor_ns3720_chp_5, 'LineWidth', 3,'Color', colors(8,:), 'LineStyle', '--');

legend({ '','Fjernvarme - Trondheim',  '','Fjernvarme - Oslo','','Fjernvarme - Trondheim 80% beneficial', '','Fjernvarme - Oslo 80% beneficial','Luft-til-vann varmepumpe', 'Grunnvarmepumpe'} )
box on
...
em_Trd_80_dh = Trondheim_80_eur.B_emission_intensity_dh_delivered_heat_mean_gCO2eq_per_kWh;
em_Oslo_80_dh = Oslo_80_eur.B_emission_intensity_dh_delivered_heat_mean_gCO2eq_per_kWh;

err_Trd_80 = Trondheim_80_eur.B_emission_intensity_dh_delivered_heat_gCO2eq_per_kWh_std_high-em_Trd_80_dh;
err_Oslo_80 = Oslo_80_eur.B_emission_intensity_dh_delivered_heat_gCO2eq_per_kWh_std_high-em_Oslo_80_dh;
...
plot(B_cont, em_hp_eu_ns3720, 'LineWidth', 3,'Color', 'black', 'LineStyle', '--');
%plot(B_cont, em_hp_eu_ns3720, 'LineWidth', 2,'Color', colors(5,:), 'LineStyle', '--');
plot(B_cont, em_hp_eu_ns3720_chp_5, 'LineWidth', 3,'Color', colors(8,:), 'LineStyle', '--');
